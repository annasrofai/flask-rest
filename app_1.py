...
# di bawah ini hanya endpoint awal  lur
...
# di bawah ini hanya coba coba  lur
...
@app.route('/api/coba_sentimen/provider/<string:provider_pilihan>/periode/<string:tanggal_awal>/<string:tanggal_akhir>', methods=['GET'])
def get_all_coba_sentimen_saja_provider_date_to_date(provider_pilihan, tanggal_awal, tanggal_akhir):
    todos = repo.get_all_tweet_saja_provider_date_to_date(provider_pilihan,
                                                          tanggal_awal, tanggal_akhir)
    tweets_df = pd.DataFrame(todos)
    if tweets_df.empty == False:
        ...
        sentimen_pos_total_persen = (
            (sentimen_pos_total / sentimen_all_total) * 100).round(2)
        sentimen_neg_total_persen = (
            (sentimen_neg_total / sentimen_all_total) * 100).round(2)
        print(sentimen_pos_total)
        print(sentimen_neg_total)
        print(sentimen_all_total)
...
@app.route('/api/coba_tweet/provider/<string:provider_pilihan>/periode/<string:tanggal_awal>/<string:tanggal_akhir>', methods=['GET'])
def get_all_coba_tweet_saja_provider_date_to_date(provider_pilihan, tanggal_awal, tanggal_akhir):
    todos = repo.get_all_tweet_saja_provider_date_to_date(provider_pilihan,
                                                          tanggal_awal, tanggal_akhir)
    tweets_df = pd.DataFrame(todos)
    if tweets_df.empty == False:
...
@app.route('/api/coba_kata/provider/<string:provider_pilihan>/periode/<string:tanggal_awal>/<string:tanggal_akhir>', methods=['GET'])
def get_all_coba_kata_provider_date_to_date(provider_pilihan, tanggal_awal, tanggal_akhir):
    todos = repo.get_all_tweet_saja_provider_date_to_date(provider_pilihan,
                                                          tanggal_awal, tanggal_akhir)
...
def get_all_fix_sentimen_saja_provider_date_to_date(provider_pilihan, tanggal_awal, tanggal_akhir):
    todos = repo.get_all_tweet_saja_provider_date_to_date(provider_pilihan,
                                                          tanggal_awal, tanggal_akhir)
    tweets_df = pd.DataFrame(todos)
    if tweets_df.empty == False:
...
def get_all_fix_tweet_saja_provider_date_to_date(provider_pilihan, tanggal_awal, tanggal_akhir):
    todos = repo.get_all_tweet_saja_provider_date_to_date(provider_pilihan,
                                                          tanggal_awal, tanggal_akhir)
    tweets_df = pd.DataFrame(todos)
    if tweets_df.empty == False:
